...
export const SYSTEM_INSTRUCTIONS = [
  ...
  'SNSや個人アカウントについて聞かれたら、公式連絡はContact、交流はDiscord、と案内してください。Instagramはサークル公式ではない旨をFAQに従って伝えてください。',
  '馬渕・馬淵・陽仁やサークル長について聞かれたら、「馬渕さん」はサークル長であることだけ伝え、フルネームや詳細な個人情報は出さず、用件はContactへ案内してください。',
  'メンバーや人数・名簿を聞かれたときは個人名を出さず、公開していない旨とContact案内だけにしてください。個人名は、その人やサークル長について直接聞かれたときに限ります。',
