...
const CIRCLE_ACTION = /^(?:活動(?:内容)?(?:は|って|について|を(?:教えて|知りたい))?|(?:何|なに)してる(?:の)?|参加(?:したい|方法(?:は)?|できますか|するには|について)?|入りたい|(?:入会|加入)(?:したい|方法(?:は)?|について)?|見学(?:したい|できますか|方法(?:は)?|について)?|(?:メンバー|部員|人数)(?:は|何人|について|を教えて)?|(?:会費|参加費)(?:は|いくら|について)?|(?:連絡先|問い合わせ)(?:は|について|を教えて)?|(?:コミュニティ|作品|制作物)(?:は|について|を(?:見たい|教えて)|に参加したい)?)$/;
...
export function classifyAssistantScope(
  ...
  if (CIRCLE_ACTION.test(normalizeScopePhrase(message))) {
